...
//Imports - here we need to add Jena Lib to our Project Libraries
...
class OpenOWL {
   ...
   //Connexion
    ...
    java.io.InputStream in = FileManager.get().open( "C:/pizza.owl" ); // be sure file into c:\
    if (in == null) {
